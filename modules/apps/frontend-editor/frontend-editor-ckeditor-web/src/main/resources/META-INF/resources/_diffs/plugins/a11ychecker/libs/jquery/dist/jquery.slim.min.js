...
!(function (e, t) {
	...
	'object' == typeof module && 'object' == typeof module.exports
		...
		: t(e);
})('undefined' != typeof window ? window : this, (g, e) => {
	'use strict';
	var t = [],
	...
	(E.event = {
		...
		E.each({focus: 'focusin', blur: 'focusout'}, (e, t) => {
			E.event.special[e] = {
				setup() {
	...
	E.extend({
		...
		(E.cssHooks.marginLeft = Fe(m.reliableMarginLeft, (e, t) => {
			if (t) {
				return (
		...
		E.each({margin: '', padding: '', border: 'Width'}, (i, o) => {
			(E.cssHooks[i + o] = {
				expand(e) {
					for (
						var t = 0,
	...
	E.fn.extend({
		...
		E.each(E.expr.match.bool.source.match(/\w+/g), (e, t) => {
	...
	E.extend(E.event, {
		...
		m.focusin ||
			E.each({focus: 'focusin', blur: 'focusout'}, (n, r) => {
				var i = function (e) {
	...
	(E.param = function (e, t) {
		...
		E.each(['top', 'left'], (e, n) => {
			E.cssHooks[n] = Fe(m.pixelPosition, (e, t) => {
				if (t) {
					return (
						(t = We(e, n)),
		...
		E.each({Height: 'height', Width: 'width'}, (a, s) => {
			E.each(
