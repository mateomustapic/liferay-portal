...
!(function () {
	...
	(C = (function () {
		...
		function e(t, e) {
			...
			return (n =
				t.element.getPosition(e.element) & CKEDITOR.POSITION_FOLLOWING
					? 1
					: -1);
		}
		...
		return (
			...
			(t.prototype.resetFocus = function () {
				if (-1 !== this.currentIndex) {
					...
					(this.currentIndex = -1),
						this.fire('focusChanged', {current: null, previous: t});
				}
			}),
			(t.prototype.getFocused = function () {
				return -1 != this.currentIndex
					? this.getItem(this.currentIndex)
					: null;
			}),
			...
			(t.prototype.next = function () {
				return this.count()
					? (this.currentIndex + 1 > this.count() - 1
							? 0 !== this.currentIndex && this.moveTo(0)
			...
			(t.prototype.prev = function () {
				...
				return (
					0 === this.currentIndex || -1 == this.currentIndex
						? this.currentIndex != t && this.moveTo(t)
						: this.moveTo(this.currentIndex - 1),
					this.getFocused()
				);
			}),
			...
			(t.prototype.getIssuesByElement = function (t, e) {
				for (
					var n, i, s = [], a = this.list, r = 0, o = a.length;
					o > r;
					r++
				) {
					(n = a[r]),
						(i = !e || !n.isIgnored()),
						n.element.equals(t) && i && s.push(n);
				}
		...
		(k = (function () {
			...
			return (
				...
				(t.prototype.setIgnored = function (t) {
					var e,
						n = (this.element.data('a11y-ignore') || '').split(',');
					if (((this._ignored = null), t)) {
						n[0] || 1 !== n.length
							? n.push(this.id)
							: (n[0] = this.id);
					}
						...
						for (
							;
							-1 !== (e = CKEDITOR.tools.indexOf(n, this.id));
					...
					return e[a]
						...
						: (n[a] || (n[a] = []),
						  ...
						  void (
								...
								((i = {name: a}),
								(e[a] = !1),
								(s = this.fire('requested', i)),
								s !== !1 && this.requestQuickFix(t))
						  ));
				}),
		...
		(e = (function (t) {
			...
			return (
				(e.prototype.get = function (e) {
					return (
						(e.langCode = e.langCode || 'en'),
						this.deferGetCall(e.langCode, arguments)
							? void 0
							: (CKEDITOR.plugins.a11ychecker.dev ||
									(e.name = e.langCode + '/' + e.name),
							  t.prototype.get.call(this, e))
					);
				}),
				...
				(e.prototype.deferGetCall = function (t, e) {
					...
					return !CKEDITOR.plugins.a11ychecker.dev ||
						this._langDictionary[t]
						? !1
						: (this._addDeferredGet(t, e),
						  -1 === n(i, t) &&
								(i.push(t),
								CKEDITOR.scriptLoader.load(
									this.basePath + 'lang/' + t + '.js'
								)),
						  !0);
				}),
			...
			return (
				...
				(t.prototype.init = function () {
					var t = this.controller,
						e = t.editor;
					e && e.fire('lockSnapshot', {dontUpdate: !0}),
						t.issues && t.editableDecorator.markIssues(t.issues),
						CKEDITOR.env.chrome &&
							t.editor &&
							(this._storedSel = t.editor
								.getSelection()
								.createBookmarks());
				}),
				(t.prototype.close = function () {
					...
					t.editableDecorator.removeMarkup(),
						t.viewerController &&
							t.viewerController.viewer.panel.hide(),
						t.issues && t.issues.resetFocus(),
						this._storedSel &&
							this.controller.editor
								.getSelection()
								.selectBookmarks(this._storedSel),
		...
		(a = (function () {
			...
			function n(t, e, n) {
				...
				var i = new RegExp('(\\s+' + e + '="\\d+")', 'g'),
					s = decodeURIComponent(t.data('cke-realelement')).replace(
						i,
						''
					),
					a = s.replace(
						...
						'$1' +
							e +
							'="' +
							CKEDITOR.tools.htmlEncodeAttr(n) +
							'" '
					);
			...
			function i(t, e) {
				var n = new RegExp('(\\s+' + e + '="\\d+")', 'g'),
					i = decodeURIComponent(t.data('cke-realelement')).replace(
						n,
						''
					);
			...
			return (
				(t.prototype = {}),
				(t.prototype.constructor = t),
				(t.prototype.testabilityClasses = {
					0: 'cke_a11yc_notice',
				...
				(t.prototype.markIssues = function (t) {
					var e,
						...
						i = t.count();
					for (n = 0; i > n; n++) {
						(e = t.getItem(n)), this.markIssueElement(e, t);
					}
				}),
					...
					n.attachListener(n, 'click', s),
						...
						e.dataProcessor.htmlFilter.addRules({
							elements: {
								$(n) {
									return (
										e._.a11ychecker.disableFilterStrip ||
											delete n.attributes[
												t.ID_ATTRIBUTE_NAME_FULL
											],
										e.config.a11ychecker_noIgnoreData &&
											delete n.attributes[
												'data-a11y-ignore'
											],
										n
				...
				(t.prototype.applyMarkup = function () {
					...
					i.forEach(
						(i) => {
							return (
								i.data(t.ID_ATTRIBUTE_NAME, a),
								s && e(i) && n(i, t.ID_ATTRIBUTE_NAME_FULL, a),
								(a += 1),
								!0
							);
						},
				...
				(t.prototype.removeMarkup = function () {
					...
					n.forEach(
						(n) => {
							n.removeAttribute &&
								n.removeAttribute(t.ID_ATTRIBUTE_NAME_FULL),
								s && e(n) && i(n, t.ID_ATTRIBUTE_NAME_FULL),
								n.hasClass('cke_a11yc_issue') && a(n);
						},
						CKEDITOR.NODE_ELEMENT,
						!1
					);
				...
				(t.prototype.resolveEditorElements = function (e) {
					...
					for (s = 0, a = e.count(); a > s; s++) {
						(n = e.getItem(s)),
							(i = n.originalElement.data(t.ID_ATTRIBUTE_NAME)),
							i === String(t.INITIAL_ID_VALUE)
								? (n.element = r)
								: (n.element = r.findOne(
										'*[' +
											t.ID_ATTRIBUTE_NAME_FULL +
				...
				(t.prototype.markIssueElement = function (t, e) {
					...
					void 0 === i && (i = 1),
						n.addClass('cke_a11yc_issue'),
						s
							? this.markIgnoredIssue(t)
							: (n.addClass(this.testabilityClasses[i]),
							  n.removeClass('cke_a11yc_ignored'));
				}),
			...
			return (
				...
				(t.prototype.getFromList = function (e) {
					...
					return 0 === e.count()
						...
						? (i &&
								t._nodeIsRemoved(i) &&
								(i = t._retreiveElementFromSelection(
									i.getDocument()
								)),
						  e.each((t) => {
								s ||
		...
		(o = (function () {
			...
			return (
				(t.prototype = {
					...
					hide() {
						this._selectIssue(),
							this.getEditorCommand().setState(
								CKEDITOR.TRISTATE_OFF
							);
					},
					update() {
						this.controller.issues.on(
							'focusChanged',
							this.focusChanged,
							this
						);
					...
					focusChanged(t) {
						var e = t.data;
						e.previous && this.unmarkFocus(e.previous.element),
							e.current && this.markFocus(e.current.element);
					},
					unmarkFocus(t) {
		...
		(c = (function () {
			...
			function t(t) {
				...
				for (var e in this.templateDefinitions) {
					this.templates[e] = new CKEDITOR.template(
						this.templateDefinitions[e]
					);
				}
				(this.parts = {}),
					(this.lang = t.editor.lang.a11ychecker),
					this.build();
			}
			...
			return (
				(t.prototype = {
					templateDefinitions: {
						wrapper:
							'<div class="cke_a11yc_ui_desc_wrapper"></div>',
						title:
							'<strong class="cke_a11yc_ui_desc_title" aria-live="polite"></strong>',
						info:
							'<p class="cke_a11yc_ui_desc_info" aria-live="polite"></p>',
					},
					setTitle(t) {
					...
					build() {
						(this.parts = {
							wrapper: CKEDITOR.dom.element.createFromHtml(
								this.templates.wrapper.output()
							),
							title: CKEDITOR.dom.element.createFromHtml(
								this.templates.title.output()
							),
							info: CKEDITOR.dom.element.createFromHtml(
								this.templates.info.output()
							),
						}),
		...
		(u = (function (t) {
			...
			function e(t, e) {
				...
				for (var n in this.templateDefinitions) {
					this.templates[n] = new CKEDITOR.template(
						this.templateDefinitions[n]
					);
				}
				(this.templates.counterText = new CKEDITOR.template(
					this.lang.navigationCounter
				)),
					(this.parts = {}),
					this.build();
			}
			...
			return (
				...
				(e.prototype = {
					templateDefinitions: {
						...
						counter:
							'<div class="cke_a11yc_ui_navigation_counter" aria-live="polite"></div>',
						buttonWrapper:
							'<div class="cke_a11yc_ui_button_wrapper"></div>',
						button:
							'<a href="javascript:void(0)" hidefocus="true" class="cke_a11yc_ui_button cke_a11yc_ui_{class}" role="button"><span class="cke_a11yc_ui_button"><span>{text}</span></span></a>',
					},
					update(t, e, n) {
						var s = this.lang.testability,
							a = s[void 0 !== n ? n : 1],
							r = i[void 0 !== n ? n : 1];
						this.parts.counter.setText(
							this.templates.counterText.output({
								current: t + 1,
								total: e,
								testability: a,
							})
						...
						for (var o in i) {
							this.parts.wrapper.removeClass(
								'cke_a11yc_testability_' + i[o]
							);
						}
						this.parts.wrapper.addClass(
							'cke_a11yc_testability_' + r
						);
					},
					build() {
						this.parts = {
							...
							counter: CKEDITOR.dom.element.createFromHtml(
								this.templates.counter.output()
							),
							previous: CKEDITOR.dom.element.createFromHtml(
								this.templates.button.output({
									title: this.lang.navigationPrevTitle,
									class: 'previous',
									text: this.lang.navigationPrev,
								})
							),
							next: CKEDITOR.dom.element.createFromHtml(
								this.templates.button.output({
						...
						var t = CKEDITOR.dom.element.createFromHtml(
								this.templates.buttonWrapper.output()
							),
							e = t.clone();
			...
			return (
				(t.prototype = {
					wrapperTemplate: new CKEDITOR.template(
						'<div role="presentation" class="cke_a11yc_ui_input_wrapper"><label class="cke_a11yc_ui_input_label" id="{id}_label" for="{id}">{label}</label></div>'
					),
					getValue() {
			...
			var e = {
				Text(e, n) {
					t.apply(this, arguments),
						(this.input = CKEDITOR.dom.element.createFromHtml(
							this.inputTemplate.output({id: this.id})
						)),
				...
				Select(e, n) {
					...
					for (i in n.options) {
						(s = new CKEDITOR.dom.element('option')),
							s.setText(n.options[i]),
							s.setAttribute('value', i),
							s.appendTo(this.input),
							(this.options[i] = s);
					}
			...
			return (
				(e.Text.prototype = CKEDITOR.tools.extend(new t(), {
					inputTemplate: new CKEDITOR.template(
						'<input class="cke_a11yc_ui_input cke_a11yc_ui_input_text" type="text" id={id} aria-labelledby="{id}_label" aria-required="true">'
					),
				})),
				(e.Checkbox.prototype = CKEDITOR.tools.extend(
					...
					{
						inputTemplate: new CKEDITOR.template(
							'<input class="cke_a11yc_ui_input cke_a11yc_ui_input_checkbox" type="checkbox" id={id} aria-labelledby="{id}_label" aria-required="true">'
						),
						getValue() {
				...
				(e.Select.prototype = CKEDITOR.tools.extend(new t(), {
					inputTemplate: new CKEDITOR.template(
						'<select class="cke_a11yc_ui_input_select" id={id} aria-labelledby="{id}_label" aria-required="true"></select>'
					),
				})),
				e
			);
		...
		(h = (function (t) {
			...
			return (
				(e.prototype = {
					templateDefinitions: {
						wrapper:
							'<div role="presentation" class="cke_a11yc_ui_form"></div>',
						fieldset:
							'<div role="presentation" class="cke_a11yc_ui_form_fieldset"></div>',
						actionset:
							'<div role="presentation" class="cke_a11yc_ui_form_actionset"></div>',
						buttonWrapper:
							'<div class="cke_a11yc_ui_button_wrapper {class}"></div>',
						button:
							'<a href="javascript:void(0)" hidefocus="true" class="cke_a11yc_ui_button {class}" role="button"><span class="cke_a11yc_ui_button">{text}</span></a>',
					},
					addInput(e, n) {
						(this.inputs[e] = new t[
							CKEDITOR.tools.capitalize(n.type)
						](e, n)),
							this.inputs[e].wrapper.appendTo(
								this.parts.fieldset
							),
							this.fire('addInput', this.inputs[e]);
					},
					removeInput(t) {
						this.inputs[t].remove(),
							this.fire('removeInput', this.inputs[t]),
							(this.inputs[t] = null);
					},
					setInputs(t) {
					...
					build() {
						...
						(this.parts = {
							...
							fieldset: CKEDITOR.dom.element.createFromHtml(
								this.templates.fieldset.output()
							),
							actionset: CKEDITOR.dom.element.createFromHtml(
								this.templates.actionset.output()
							),
							quickfixButton: CKEDITOR.dom.element.createFromHtml(
								this.templates.button.output({
							...
							ignoreButton: CKEDITOR.dom.element.createFromHtml(
								this.templates.button.output({
					...
					setIgnored(t) {
						...
						e
							.getFirst()
							.setHtml(
								this.viewer.editor.lang.a11ychecker[
									t ? 'stopIgnoreBtn' : 'ignoreBtn'
								]
							),
			...
			return (
				(t.prototype = {
					templateDefinitions: {
						...
						info: '<p>{text}</p>',
						button:
							'<a href="javascript:void(0)" title="{title}" hidefocus="true" class="cke_a11yc_ui_button" role="button"><span class="cke_a11yc_ui_button">{text}</span></a>',
					},
					build() {
						var t = this.viewer.editor.lang.a11ychecker;
						(this.parts = {
		...
		(f = (function () {
			...
			return (
				...
				(t.prototype.addItem = function (t) {
					t.on('keydown', this.keyDownListener, this),
						this.list.push(t),
						this.sort();
				}),
				(t.prototype.removeItem = function (t) {
					'number' != typeof t &&
						(t = CKEDITOR.tools.indexOf(this.list, t)),
						this.list[t].removeListener(
							'keydown',
				...
				(t.prototype.getNext = function (t) {
					var e,
						n = 0,
						i = this.list.length;
					'number' == typeof t && i > t + 1 && (n = t + 1),
						(e = this.getItem(n));
					var s, a;
					for (s = 1; i - 1 > s && !e.isVisible(); s++) {
						(a = n + s), a >= i && (a -= i), (e = this.getItem(a));
					}
				...
				(t.prototype.getPrev = function (t) {
					var e,
						n = this.list.length,
						i = n - 1;
					'number' == typeof t && t > 0 && (i = t - 1),
						(e = this.getItem(i));
					var s, a;
					for (s = 1; n - 1 > s && !e.isVisible(); s++) {
						(a = i - s),
							0 > a && (a = n + a),
							(e = this.getItem(a));
					}
				...
				(t.prototype._sort = function (t, e) {
					...
					return (n =
						t.getPosition(e) & CKEDITOR.POSITION_FOLLOWING
							? 1
							: -1);
				}),
				t
		...
		(g = (function () {
			...
			function t(t, e) {
				(this.viewer = t),
					...
					(this.panelShowListeners = this.panelShowListeners(t)),
				...
				(t.prototype = {
					...
					addPanelShowListeners(t) {
						if (this.panelShowListeners) {
							for (
								var e = 0;
								e < this.panelShowListeners.length;
								e++
							) {
								this.addPanelShowListener(
									this.viewer.panel.addShowListener(
										this.panelShowListeners[e]
									)
								);
							}
						}
					...
					removePanelShowListeners() {
						for (
							var t;
							(t = this.activePanelShowlisteners.pop());
		...
		(m = (function (t, e, n, i, s, a) {
			...
			function r(t, e) {
				(this.editor = t),
					(this.panel = new CKEDITOR.ui.balloonPanel(t, e)),
					(this.focusManager = new s()),
					(this.modes = {}),
					(this.mode = null),
					(this.lang = t.lang.a11ychecker);
				var n = this;
				(this.panel.registerFocusable = function (t) {
					...
					(this.panel.deregisterFocusable = function (t) {
						n.focusManager.removeItem(t),
							n.editor.focusManager.remove(t);
					}),
				...
				(r.prototype = {
					modesDefinition: {
						listening: {
							...
							init(t) {
								var e = this;
								t.panel.parts.panel.addClass(
									'cke_a11yc_mode_listening'
								),
									...
									CKEDITOR.tools.setTimeout(
										() => {
											...
											t.panel.parts.panel.setStyles({
												...
												bottom:
													s.height - n.bottom + 'px',
											}),
												CKEDITOR.tools.setTimeout(
													() => {
														var n = t.editor.getCommand(
															'maximize'
														);
														e[
															n && 1 === n.state
							...
							close(t) {
								t.panel.parts.panel.removeClass(
									'cke_a11yc_mode_listening'
								),
									t.panel.resize(
										t.panel.width,
						...
						checking: {
							panelShowListeners(t) {
								return [
									function () {
										var e = t.editor,
											n = CKEDITOR.tools.eventsBuffer(
												r.SCROLL_THROTTLING_RATE,
												() => {
					...
					setupNavigation() {
						(this.navigation = new e(
							...
							this.panel.registerFocusable(
								this.navigation.parts.previous
							),
							this.panel.registerFocusable(
								this.navigation.parts.next
							),
							this.panel.parts.content.append(
								this.navigation.parts.wrapper
							);
					},
					setupDescription() {
						(this.description = new t(this)),
							this.panel.parts.content.append(
								this.description.parts.wrapper
							);
					},
					setupForm() {
						(this.form = new n(this, this.editor.lang.a11ychecker)),
							...
							this.form.on(
								'removeInput',
								function (t) {
									this.panel.deregisterFocusable(
										t.data.input
									);
								},
								this
							...
							this.panel.registerFocusable(
								this.form.parts.ignoreButton
							),
							this.panel.registerFocusable(
								this.form.parts.quickfixButton
							),
							this.panel.parts.content.append(
								this.form.parts.wrapper
							);
					},
					setupListeningIndicator() {
						(this.listeningIndicator = new i(this)),
							this.panel.registerFocusable(
								this.listeningIndicator.parts.button
							),
							this.panel.parts.content.append(
								this.listeningIndicator.parts.wrapper
							);
					},
					setupModes() {
						for (var t in this.modesDefinition) {
							this.modes[t] = new a(
								this,
								this.modesDefinition[t]
							);
						}
					},
					setMode(t) {
						this.mode && this.modes[this.mode].leaveMode(),
							this.modes[t].enterMode(),
							(this.mode = t);
					},
					_fixAria() {
						var t = this,
					...
					quickFixAccepted(t) {
						...
						if (r) {
							if (((e = r.validate(a)), e.length)) {
								...
								o.length && this.inputs[o[0]].input.focus(),
									t.cancel();
							}
							else {
								i.applyQuickFix(r, a);
							...
							console.error('No quickfix available!'), t.cancel();
						}
					},
					showIssue(t, e) {
						t.element.scrollIntoView(),
							this.viewer.panel.attach(t.element),
							e &&
								(e.event && this.fire(e.event),
		...
		(b = (function () {
			...
			function t(e) {
				if (((this.controller = e), e)) {
					var n = t.parseConfig(
						e.editor.config.a11ychecker_keystrokes
					);
					this.setEditorHotkeys(e.editor, n),
						this.setBalloonHotkeys(e.viewerController, n);
				}
			}
		...
		(x = (function (t, e, n, i, s, a, r, o, c) {
			...
			function u(t) {
				(this._ = {}),
					...
					t &&
						((this.viewerController = new r(this, {
							title: t.lang.a11ychecker.balloonLabel,
						})),
						this.attachEditorListeners(t),
						(this.hotkeyManager = new o(this)));
			}
			...
			return (
				...
				(u.prototype.exec = function (t) {
					return this.enabled
						? void this.close()
						: (this.issues && this.issues.clear(),
						  this.enable(),
						  void this.check({ui: !0, callback: t}));
				}),
				(u.prototype.listen = function () {
					if (this.enabled) {
						var t = u.modes;
						if (this.modeType === t.LISTENING) {
							this.check();
						}
						else {
							var e =
								this.issues.getFocused() &&
								this.issues.getFocused().element;
							this.setMode(t.LISTENING),
								e &&
									this.editor.getSelection().selectElement(e);
						}
					}
				}),
				...
				(u.prototype.disable = function () {
					this.enabled &&
						((this.enabled = !1), this.fire('disabled'));
				}),
				(u.prototype.enable = function () {
					this.enabled ||
						((this.enabled = !0),
						this.fire('enabled'),
						this.setMode(u.modes.CHECKING));
				}),
				(u.prototype.next = function (t) {
					...
					0 !== n.count() &&
						((e = this.issues.next()),
						this.viewerController.showIssue(e, {
							event: 'next',
							callback: t,
						}));
				}),
				...
				(u.prototype.showIssue = function (t, e) {
					...
					return (
						'number' != typeof a && (a = s.indexOf(a)),
						(n = s.getItem(a)),
						n && n == s.getFocused()
							? (r.call(this.viewerController), !0)
							: ((i = s.moveTo(a)),
							  i &&
									this.viewerController &&
									this.viewerController.showIssue(
										s.getItem(a),
										{callback: r}
									),
							  i)
				...
				(u.prototype.ignoreIssue = function () {
					...
					t &&
						(t.setIgnored(!t.isIgnored()),
						this.editableDecorator.markIssueElement(
							t,
							this.issues
						));
				}),
				...
				(u.prototype.setMode = function (i) {
					var s,
						a = {};
					if (
						((a[u.modes.CHECKING] = t),
						(a[u.modes.LISTENING] = e),
						(a[u.modes.BUSY] = n),
						(s = a[i]),
						!s)
					) {
						throw new Error(
							'Invalid mode value, use Controller.modes members'
						);
					}
					i !== this.modeType &&
						(this.mode && this.mode.close(),
						(this.mode = new s(this)),
						this.mode.init(),
						(this.modeType = i));
				}),
					...
					t.on('beforeSetMode', () => {
						...
						t.on(
							...
							(t) => {
								...
								-1 === CKEDITOR.tools.indexOf(n, i) &&
									e.enabled &&
									e.setMode(u.modes.LISTENING);
							},
							null,
							null,
							9999
				...
				(u.prototype.applyQuickFix = function (t, e) {
					this._withUndoManager(function () {
						...
						this.editableDecorator.removeMarkup(),
							t.markSelection(n, n.getSelection()),
							e.unsetStoredSelection && e.unsetStoredSelection(),
				...
				(u.prototype.getTempOutput = function () {
					...
					return (
						t.scratchpad ||
							((t.scratchpad = CKEDITOR.document.createElement(
								'div'
							)),
							t.scratchpad.setStyle('display', 'none')),
						t.scratchpad
					);
				}),
				...
				(u.prototype._engineProcessed = function (t, e) {
					...
					s.editableDecorator.resolveEditorElements(t),
						...
						n !== !1 &&
							(t.count()
								? ((i =
										s.preferredIssueFinder.getFromListIndex(
											t
										) || 0),
								  i >= t.count() && (i = 0),
								  s.showIssue(t.getItem(i)))
								: s.onNoIssues());
				}),
				(u.prototype._withUndoManager = function (t) {
					var e = this.editor,
						n = !!e.undoManager.locked;
					n && e.fire('unlockSnapshot'),
						t.call(this),
						n && e.fire('lockSnapshot', {dontUpdate: !0});
				}),
		...
		(function () {
			...
			function c(t) {
				var e = this.config,
					n = e.contentsCss;
				CKEDITOR.tools.isArray(n) || (e.contentsCss = n ? [n] : []),
					e.contentsCss.push(t);
			}
			var u = 'a11ychecker';
			CKEDITOR.plugins.add(u, {
					...
					CKEDITOR.document.appendStyleSheet(
						...
						(function (e, n, i, s, a) {
							CKEDITOR.tools.extend(
								...
								(CKEDITOR.plugins.a11ychecker.quickFixes = new a(
									t + 'quickfix/'
								));
						})(T, k, C, I, e);
				},
				beforeInit(t) {
					var e = this;
					t.config.a11ychecker_noIgnoreData ||
						t.filter.allow('*[data-a11y-ignore]', 'a11ychecker'),
						...
						t.once('instanceReady', () => {
							!(function (n) {
								...
								(t._.a11ychecker = i),
									s.getEngineType((n) => {
										i.setEngine(new n(e)),
											(i.engine.config = i.engine.createConfig(
												t
											)),
											s.fire('loaded', null, t);
									});
							})(x);
						}),
				...
				createTemporaryNamespace(t) {
					(t._.a11ychecker = {
						getEngineType(t) {
							...
							var n,
								i,
								s = CKEDITOR.plugins.a11ychecker,
								a = s.Engine,
								r = s.IssueList,
								o = s.Issue,
								c = s.IssueDetails,
							...
							!(function (t) {
								...
								(function () {
									if (!u || !u.fn) {
										throw new Error(
											"Missing jQuery. Accessibility Checker's default engine, Quail.js requires jQuery to work correctly."
										);
									}
									u.fn.quail ||
										!(function (t) {
											...
											var e = {
													...
													wcag: {
														setup(t, e, n) {
															...
															for (var i in this
																.successCriteria) {
																if (
																	this.successCriteria.hasOwnProperty(
																		i
																	)
																) {
																	var s = this
																	...
																	s.registerTests(
																		...
																		e &&
																			...
																			'function' ==
																				typeof e.listenTo &&
																			n.successCriteriaEvaluated &&
																			e.listenTo(
																				s,
																				'successCriteriaEvaluated',
																				n.successCriteriaEvaluated
																			);
																}
															}
												...
												run(n) {
													...
													function s() {
														if (
															'undefined' !=
															typeof n.customTests
														) {
															for (var t in n.customTests) {
																n.customTests.hasOwnProperty(
																	t
																) &&
																	((n.customTests[
																		t
													...
													if (
														(n.reset &&
															(e.accessibilityResults = {}),
														(e.tests = e.lib.TestCollection(
															[],
															{
																scope:
																	e.html ||
												...
												getTextContents(t) {
													if (
														t.is(
															'p, pre, blockquote, ol, ul, li, dl, dt, dd, figure, figcaption'
														)
													) {
														return t.text();
													}
											...
											if (
												...
												(e.components.color = (function () {
														...
														t.add(
															n({
																...
																expected: (function (
																	...
																	return e.components.resolveExpectation(
																		t,
																		n
																	);
																})(i, a),
													...
													var r = {
														...
														passesWCAGColor(
															...
															var a = e.components.convertToPx(
																t.css(
																	'fontSize'
																)
															);
														...
														passesWAIColor(t, e) {
															var n = r.getWAIErtContrast(
																	t,
																	e
																),
																i = r.getWAIErtBrightness(
																	t,
																	e
																);
														...
														traverseVisualTreeForBackground(
															e,
															n
														) {
															e.attr(
															...
															for (
																var l = document.elementFromPoint(
																	c,
																	u
																);
																void 0 === a &&
														...
														getBehindElementBackgroundColor(
															t
														) {
															return r.traverseVisualTreeForBackground(
																t,
																'background-color'
															);
														},
														getBehindElementBackgroundGradient(
															t
														) {
															return r.traverseVisualTreeForBackground(
																t,
														...
														getBehindElementBackgroundImage(
															t
														) {
															return r.traverseVisualTreeForBackground(
																t,
												...
												(e.components.convertToPx = function (
													n
												) {
													if (n.search('px') > -1) {
													...
													var i = t(
															'<div style="display: none; font-size: 1em; margin: 0; padding:0; height: ' +
																n +
																'; line-height: 1; border:0;">&nbsp;</div>'
														).appendTo(e.html),
														s = i.height();

													return i.remove(), s;
												}),
												(e.components.event = function (
													e,
													n,
													i,
													s
													...
													r.each(function () {
														var s,
															...
															r = e.components.hasEventListener(
																t(this),
																a
															);
														t._data &&
														...
														var u =
																...
																!!s[a].length,
															l = !!c.length,
															d = e.components.hasEventListener(
																t(this),
																c.replace(
																	'on',
																	''
												...
												(e.components.hasEventListener = function (
													e,
													n
												) {
													return 'undefined' !=
														...
														? !0
														: t(e).is(
																'a[href], input, button, video, textarea'
														  ) &&
														  'undefined' !=
																typeof t(e)[0][
																	n
												...
												(e.components.headingLevel = function (
													e,
													n,
													i,
													s
												...
												(e.components.htmlSource = {
													...
													parseHtml(t) {
														...
														var e = new Tautologistics.NodeHtmlParser.HtmlBuilder(
																() => {},
																{}
															),
															n = new Tautologistics.NodeHtmlParser.Parser(
																e
															);
														n.parseComplete(t);
														var i = e.dom,
												...
												Tautologistics.NodeHtmlParser.HtmlBuilder.prototype.write = function (
													t
												) {
													if (
														(this._done &&
											...
											var i = function () {
												var t,
													...
													x = function (t) {
														var e = new Error(
															'Comment ending not found for: `comment` at line: ' +
																t.line +
																' char: ' +
																t['char']
														);
											...
											(e.components.htmlTagValidator = i()),
												...
												(e.components.labelProximity = function (
													e,
													n,
													i,
													s
												...
												(e.components.placeholder = function (
													e,
													n,
													i,
													s
														...
														.each(function () {
															...
															if (
																...
																r && r[0].length
																	...
																	: e.strings.placeholders.indexOf(
																			n
																	  ) > -1
																	? a(
																			this,
												...
												(e.components.resolveExpectation = function (
													e,
													n
												) {
													var i,
												...
												(e.components.selector = function (
													e,
													n,
													i,
													s
												...
												(e.statistics = {
													...
													average(t, n) {
														...
														return e.statistics.setDecimal(
															s / t.length,
															n
														);
													},
													...
													providers: {
														youTube: {
															selector:
																'a, iframe',
															apiUrl:
																'http://gdata.youtube.com/feeds/api/videos/?q=%video&caption&v=2&alt=json',
															isVideo(t) {
															...
															hasCaptions(e, n) {
																var i = this.getVideoId(
																	e
																);
																t.ajax({
																	url: this.apiUrl.replace(
																		'%video',
																		i
																	),
																	async: !1,
														...
														videoElement: {
															...
															hasCaptions(n, i) {
																...
																var a = e.components.language.getDocumentLanguage(
																	n,
																	!0
																);
																n.parents(
												...
												(e.KINGUseCurrencyAsSymbol = function (
													e,
													n,
													i
												) {
												...
												(e.KINGUseLongDateFormat = function (
													e,
													n,
													i
												) {
													...
													var a =
														'a, article, aside, b, blockquote, caption, cite, dd, del, div, em, figcaption, footer, h1, h2, h3, h4, h5, h6, header, i, label, legend, li, mark, nav, option, p, q, s, section, small, span, strong, sub, summary, sup, td, th, title, u';
													n.get('$scope')
														.find(a)
														.each(s);
												}),
												(e.KINGUsePercentageWithSymbol = function (
													e,
													n,
													i
												) {
												...
												(e.aAdjacentWithSameResourceShouldBeCombined = function (
													e,
													n,
													i
												) {
												...
												(e.aImgAltNotRepetitive = function (
													e,
													n,
													i
												) {
												...
												(e.aInPHasADistinctStyle = function (
													e,
													n,
													i
												) {
												...
												(e.aLinkTextDoesNotBeginWithRedundantWord = function (
													e,
													n,
													i
												) {
												...
												(e.aLinksAreSeparatedByPrintableCharacters = function (
													e,
													n,
													i
												) {
												...
												(e.aLinksDontOpenNewWindow = function (
													e,
													n,
													i
												) {
												...
												(e.aLinksNotSeparatedBySymbols = function (
													e,
													n,
													i
												) {
												...
												(e.aSuspiciousLinkText = function (
													e,
													n,
													i
												) {
													n.get('$scope')
														...
														.each(function () {
															...
															t(this)
																...
																s.set(
																	e.strings.suspiciousLinks.indexOf(
																		e.cleanString(
																			a
																		)
																	) > -1
												...
												(e.animatedGifMayBePresent = function (
													e,
													n,
													i
												) {
												...
												(e.appletContainsTextEquivalent = function (
													e,
													n,
													i
												) {
													n.get('$scope')
														.find(
															'applet[alt=""], applet:not(applet[alt])'
														)
														.each(function () {
															var s = i({
																element: this,
												...
												(e.ariaOrphanedContent = function (
													e,
													n,
													i
												) {
													...
													s.each(function () {
														...
														var r = e.find(
															'*:not(*[role] *, *[role], script, meta, link)'
														);
														r.length
															? r.each(
																	function () {
												...
												(e.blockquoteUseForQuotations = function (
													e,
													n,
													i
												) {
												...
												(e.closingTagsAreUsed = function (
													e,
													n,
													i
												) {
													e.components.htmlSource.getHtml(
														(s, a) => {
															e.components.htmlSource.traverse(
																a,
																(s) => {
																	if (
																		'tag' ===
												...
												(e.colorBackgroundGradientContrast = function (
													e,
													n,
													i,
													s
													...
													function a(t, e, n, i, s) {
														...
														if (d) {
															...
															for (
																u = new Rainbow(),
																	u.setSpectrumByArray(
																		d
																	),
																	l =
																		d.length *
																		n.gradientSampleMultiplier,
																	a = !1,
																	h = 0;
																!a && l > h;
																h++
															) {
																var p = r.testElmBackground(
																	n.algorithm,
																	i,
																	'#' +
																		u.colourAt(
																...
																p ||
																	(o(
																		...
																		'failed',
																		c,
																		'The background gradient makes the text unreadable'
																	),
																	(a = !0));
															}
															a ||
																o(
																	...
																	'passed',
																	c,
																	'The background gradient does not affect readability'
																);
														}
													}
													var r =
													...
													n.get('$scope').each(
														function () {
															for (
																...
																e.components.color.textShouldBeTested(
																	u
																) &&
																	c.push(
																		u.parentNode
												...
												(e.colorBackgroundImageContrast = function (
													e,
													n,
													i,
													s
													...
													function a(t, e, n, i, s) {
														...
														if (a) {
															...
															(u.crossOrigin =
																'Anonymous'),
																(u.onload = function () {
																	var a = r.getAverageRGB(
																			u
																		),
																		l = r.testElmBackground(
																			n.algorithm,
																			i,
																			a
																		);
																	l
																		? o(
																				...
																				'passed',
																				c,
																				"The element's background image does not affect readability"
																		  )
																		: o(
																				t,
																				e,
																				...
																				'failed',
																				c,
																				"The element's background image makes the text unreadable"
																		  );
																}),
																(u.onerror = u.onabort = function () {
																	o(
																		...
																		'cantTell',
																		c,
																		"The element's background image could not be loaded (" +
																			a +
																			')'
																	);
																}),
												...
												(e.colorElementBehindBackgroundGradientContrast = function (
													e,
													n,
													i,
													s
													...
													function a(t, e, n, i, s) {
														...
														if (
															(i.is('option') ||
																(a = r.getBehindElementBackgroundGradient(
																	i
																)),
															a)
														) {
															...
															u
																? o(
																		...
																		'failed',
																		c,
																		'The background gradient of the element behind this element makes the text unreadable'
																  )
																: o(
																		t,
																		e,
												...
												(e.colorElementBehindBackgroundImageContrast = function (
													e,
													n,
													i,
													s
													...
													function a(t, e, n, i, s) {
														...
														if (
															(i.is('option') ||
																(a = r.getBehindElementBackgroundImage(
																	i
																)),
															a)
														) {
																...
																(u.onload = function () {
																	...
																	l
																		? o(
																				...
																				'passed',
																				c,
																				'The background image of the element behind this element does not affect readability'
																		  )
																		: o(
																				t,
																				e,
																				...
																				'failed',
																				c,
																				'The background image of the element behind this element makes the text unreadable'
																		  );
																}),
																(u.onerror = u.onabort = function () {
																	o(
																		...
																		'cantTell',
																		c,
																		'The background image of the element behind this element could not be loaded (' +
																			a +
																			')'
																	);
																}),
												...
												(e.colorElementBehindContrast = function (
													e,
													n,
													i,
													s
													...
													function a(t, e, n, i, s) {
														...
														if (
															(i.is('option') ||
																(a = r.getBehindElementBackgroundColor(
																	i
																)),
															a)
														) {
															var u = r.testElmBackground(
																n.algorithm,
																i,
																a
															);
															u
																? o(
																		...
																		'passed',
																		c,
																		'The element behind this element does not affect readability'
																  )
																: o(
																		t,
																		e,
																		...
																		'failed',
																		c,
																		'The element behind this element makes the text unreadable'
																  );
														}
													}
													var r =
													...
													function a(t, e, n, i, s) {
														r.testElmContrast(
															...
															? o(
																	...
																	'passed',
																	c,
																	'The font contrast of the text is sufficient for readability'
															  )
															: o(
																	t,
																	e,
																	...
																	'failed',
																	c,
																	'The font contrast of the text impairs readability'
															  );
													}
													var r =
															e.components.color
												...
												(e.contentPositioningShouldNotChangeMeaning = function (
													e,
													n,
													i
												) {
													...
													n.get('$scope')
														.find(
															'*:has(*:quailCss(position=absolute))'
														)
														.each(function () {
															(a = {
																top: {},
															...
															e
																.find(
																	'h1, h2, h3, h4, h5, h6, p, blockquote, ol, li, ul, dd, dt'
																)
																.filter(
																	':quailCss(position=absolute)'
																)
																.each(
																	function () {
																		for (
												...
												(e.definitionListsAreUsed = function (
													e,
													n,
													i
												) {
												...
												(e.doNotUseGraphicalSymbolToConveyInformation = function (
													e,
													n,
													i
												) {
												...
												(e.documentAbbrIsUsed = function (
													t,
													e,
													n
												) {
													t.components.acronym(
														t,
														e,
														n,
														'abbr'
												...
												(e.documentAcronymsHaveElement = function (
													t,
													e,
													n
												) {
												...
												(e.documentIDsMustBeUnique = function (
													e,
													n,
													i
												) {
												...
												(e.documentIsWrittenClearly = function (
													e,
													n,
													i
												) {
													n.get('$scope')
														.find(e.textSelector)
														.each(function () {
															var s = e.components.textStatistics.cleanText(
																	t(
																		this
																	).text()
																),
																...
																e.isUnreadable(
																	...
																	: void a.set(
																			Math.round(
																				206.835 -
																					1.015 *
																						e.components.textStatistics.averageWordsPerSentence(
																							s
																						) -
																					84.6 *
																						e.components.textStatistics.averageSyllablesPerWord(
																							s
																						)
																			) <
																				60
												...
												(e.documentLangIsISO639Standard = function (
													e,
													n,
													i
												) {
												...
												(e.documentStrictDocType = function (
													t,
													e,
													n
												) {
													e.add(
														n(
															'undefined' !=
																...
																document.doctype &&
																-1 !==
																	document.doctype.systemId.search(
																		'strict'
																	)
																? {
																		element: document,
												...
												(e.documentTitleIsShort = function (
													t,
													e,
													n
												) {
												...
												(e.documentVisualListsAreMarkedUp = function (
													e,
													n,
													i
												) {
												...
												(e.elementAttributesAreValid = function (
													e,
													n,
													i
												) {
												...
												(e.embedHasAssociatedNoEmbed = function (
													e,
													n,
													i
												) {
												...
												(e.emoticonsExcessiveUse = function (
													e,
													n,
													i
												) {
												...
												(e.emoticonsMissingAbbr = function (
													e,
													n,
													i
												) {
												...
												(e.focusIndicatorVisible = function (
													e,
													n,
													i
												) {
													n.get('$scope')
														...
														.each(function () {
															...
															var r = e.components.convertToPx(
																t(this).css(
																	'border-width'
																)
															);
												...
												(e.formWithRequiredLabel = function (
													e,
													n,
													i
												) {
													var s,
														a = e.strings.redundant,
														r = !1;
													(a.required[
														a.required.indexOf('*')
													] = /\*/g),
												...
												(e.headerTextIsTooLong = function (
													e,
													n,
													i
												) {
												...
												(e.headersAttrRefersToATableCell = function (
													e,
													n,
													i
												) {
												...
												(e.headersUseToMarkSections = function (
													e,
													n,
													i
												) {
													n
														...
														.each(function () {
															...
															var s = t(this);
															s.find(
																'strong:first, em:first, i:first, b:first'
															).each(function () {
																e.set({
																	status:
																		s
												...
												(e.headersUsedToIndicateMainContent = function (
													e,
													n,
													i
												) {
													n.get('$scope').each(
														function () {
															var s = t(this),
																a = e.components.content.findContent(
																	s
																);
															n.add(
																i(
												...
												(e.idRefHasCorrespondingId = function (
													e,
													n,
													i
												) {
												...
												(e.idrefsHasCorrespondingId = function (
													e,
													n,
													i
												) {
												...
												(e.imgAltNotEmptyInAnchor = function (
													e,
													n,
													i
												) {
												...
												(e.imgAltTextNotRedundant = function (
													e,
													n,
													i
												) {
												...
												(e.imgImportantNoSpacerAlt = function (
													e,
													n,
													i
												) {
												...
												(e.imgMapAreasHaveDuplicateLink = function (
													e,
													n,
													i
												) {
												...
												(e.imgNonDecorativeHasAlt = function (
													e,
													n,
													i
												) {
												...
												(e.imgWithMathShouldHaveMathEquivalent = function (
													e,
													n,
													i
												) {
													n.get('$scope')
														.find(
															'img:not(img:has(math), img:has(tagName))'
														)
														.each(function () {
															var e = i({
																element: this,
												...
												(e.inputCheckboxRequiresFieldset = function (
													e,
													n,
													i
												) {
												...
												(e.inputImageAltIsNotFileName = function (
													e,
													n,
													i
												) {
												...
												(e.inputImageAltIsShort = function (
													e,
													n,
													i
												) {
												...
												(e.inputImageAltNotRedundant = function (
													e,
													n,
													i
												) {
													n.get('$scope')
														...
														.each(function () {
															...
															n.add(s),
																s.set(
																	e.strings.redundant.inputImage.indexOf(
																		e.cleanString(
																			t(
																				this
																			).attr(
												...
												(e.inputWithoutLabelHasTitle = function (
													e,
													n,
													i
												) {
												...
												(e.labelsAreAssignedToAnInput = function (
													e,
													n,
													i
												) {
												...
												(e.languageChangesAreIdentified = function (
													e,
													n,
													i
												) {
													var s,
														...
														u,
														l = n.get('$scope'),
														d = e.components.language.getDocumentLanguage(
															l,
															!0
														),
														h = function (
														...
														p = function (t) {
															return t.attr(
																...
																: e.components.language.getDocumentLanguage(
																		l,
																		!0
																  );
														};
													l.find(e.textSelector).each(
														function () {
															(c = this),
																(o = t(this)),
																(d = p(o)),
												...
												(e.languageDirAttributeIsUsed = function (
													e,
													n,
													i
												) {
												...
												(e.languageDirectionPunctuation = function (
													e,
													n,
													i
												) {
												...
												(e.languageUnicodeDirection = function (
													e,
													n,
													i
												) {
												...
												(e.linkHasAUniqueContext = function (
													e,
													n,
													i
												) {
												...
												(e.listNotUsedForFormatting = function (
													e,
													n,
													i
												) {
												...
												(e.paragraphIsWrittenClearly = function (
													e,
													n,
													i
												) {
													n.get('$scope')
														...
														.each(function () {
															...
															n.add(s);
															var a = e.components.textStatistics.cleanText(
																t(this).text()
															);
															s.set(
																Math.round(
												...
												(e.preShouldNotBeUsedForTabularLayout = function (
													e,
													n,
													i
												) {
												...
												(e.scriptFocusIndicatorVisible = function () {
													e.html
														...
														.each(function () {
															...
															t(this).focus();
															var l = e.components.convertToPx(
																t(this).css(
																	'outline-width'
																)
															);
															...
															var d = e.components.convertToPx(
																t(this).css(
																	'border-width'
																)
															);
												...
												(e.skipToContentLinkProvided = function (
													e,
													n,
													i
												) {
												...
												(e.tabIndexFollowsLogicalOrder = function (
													e,
													n,
													i
												) {
												...
												(e.tableAxisHasCorrespondingId = function (
													e,
													n,
													i
												) {
												...
												(e.tableHeaderLabelMustBeTerse = function (
													e,
													n,
													i
												) {
												...
												(e.tableLayoutDataShouldNotHaveTh = function (
													e,
													n,
													i
												) {
												...
												(e.tableLayoutHasNoCaption = function (
													e,
													n,
													i
												) {
												...
												(e.tableLayoutHasNoSummary = function (
													e,
													n,
													i
												) {
												...
												(e.tableLayoutMakesSenseLinearized = function (
													e,
													n,
													i
												) {
												...
												(e.tableNotUsedForLayout = function (
													e,
													n,
													i
												) {
												...
												(e.tableShouldUseHeaderIDs = function (
													e,
													n,
													i
												) {
												...
												(e.tableSummaryDoesNotDuplicateCaption = function (
													e,
													n,
													i
												) {
												...
												(e.tableSummaryIsNotTooLong = function (
													e,
													n,
													i
												) {
												...
												(e.tableUsesAbbreviationForHeader = function (
													e,
													n,
													i
												) {
												...
												(e.tableUsesScopeForRow = function (
													e,
													n,
													i
												) {
												...
												(e.tableWithMoreHeadersUseID = function (
													e,
													n,
													i
												) {
												...
												(e.tabularDataIsInTable = function (
													e,
													n,
													i
												) {
												...
												(e.tagsAreNestedCorrectly = function (
													t,
													e,
													n
												) {
													t.components.htmlSource.getHtml(
														(i) => {
															var s = t.components.htmlTagValidator(
																	i
																),
																a = n({
																	expected: e
												...
												(e.userInputMayBeRequired = function (
													e,
													n,
													i
												) {
														...
														function () {
															...
															var s = t(
																...
																r = t(
																	...
																	'input:not(form input, [type=button],[type=reset],[type=image],[type=submit],[type=hidden])'
																);
																...
																s.each(
																	function () {
																		var e = t(
																			...
																			'input:not([type=button],[type=reset],[type=image],[type=submit],[type=hidden])'
																		);
																		e.length >
																			1 &&
																			(a =
												...
												(e.videosEmbeddedOrLinkedNeedCaptions = function (
													t,
													e,
													n
												) {
													t.components.video.findVideos(
														e.get('$scope'),
														(i, s) => {
															e.add(
																n(
																	s
																		? {
																				...
																				expected: (function (
																					...
																					return t.components.resolveExpectation(
																						e
																					);
																				})(
																					i
												...
												(e.whiteSpaceNotUsedForFormatting = function (
													e,
													n,
													i
												) {
														...
														(e.fn = e.prototype = {
															...
															resolve() {
																...
																e &&
																	...
																	1 ===
																		e.nodeType &&
																	((this.attributes.selector = this.defineUniqueSelector(
																		e
																	)),
																	this
																		.attributes
																	...
																	return n.length >
																		...
																		(n = o(
																			...
																			(
																				...
																				return /active|enabled|disabled|first|last|only|collapsed|open|clearfix|processed/.test(
																					t
																				);
																			}
																		)),
													...
													return (
														(n.fn = n.prototype = {
															...
															filterTests(t) {
																...
																if (!i) {
																	throw new Error(
																		'Success Criteria instances require a name in order to have tests filtered.'
																	);
																}
																var s = i.split(
																	':'
																				...
																				if (
																					...
																					for (
																						...
																						if (
																							...
																							throw new Error(
																								'Definition for Technique ' +
																									a +
																									' is missing from the guideline specification'
																							);
																						}
																						(r = this.findTechnique(
																							a
																						)),
																							r ||
																								((r = e.lib.Technique(
												...
												(e.lib.wcag2 = (function () {
													...
													function i(n, i, a, r) {
														var o,
															...
															l = [];
														(o = t.map(i, (t) => {
															return new e.lib.wcag2.Criterion(
																t,
																a,
																r,
																n.subject
												...
												(e.guidelines.wcag.successCriteria[
													'1.1.1'
												] = (function (t) {
													function e() {
														return !0;
												...
												(e.guidelines.wcag.successCriteria[
													...
													return (
														(n.techniques = {
															G115:
																'Using semantic elements to mark up structure AND H49: Using semantic markup to mark emphasized or special text',
															G117:
															...
															SCR21:
																'Using functions of the Document Object Model (DOM) to add content to a page (Scripting)',
															H51:
															...
															ARIA12:
																'Using role=heading to identify headings (ARIA)',
															ARIA13:
																'Using aria-labelledby to name regions and landmarks (ARIA)',
															ARIA16:
												...
												(e.guidelines.wcag.successCriteria[
													...
													return (
														(n.techniques = {
															G57:
																'Ordering the content in a meaningful sequence (scope: for all the content in the Web page)',
															H34:
																'Using a Unicode right-to-left mark (RLM) or left-to-right mark (LRM) to mix text direction inline (languageUnicodeDirection)',
															H56:
														...
														(n.failures = {
															...
															F32:
																'Using white space characters to control spacing within a word (whiteSpaceInWord)',
															F1:
																'Changing the meaning of content by positioning information with CSS',
															F34:
																'Using white space characters to format tables in plain text content (tabularDataIsInTable)',
															F33:
												...
												(e.guidelines.wcag.successCriteria[
													...
													return (
														(n.techniques = {
															...
															SCR34:
																'Calculating size and ,position in a way that scales with text size (Scripting)',
															G146:
																'Using liquid layout',
															G178:
												...
												(e.guidelines.wcag.successCriteria[
													...
													return (
														(n.techniques = {
															C22:
																'Using CSS to control visual presentation of text (CSS)',
															C30:
												...
												(e.guidelines.wcag.successCriteria[
													...
													return (
														(n.techniques = {
															...
															H70:
																'Using frame elements to group blocks of repeated material AND H64: Using the title attribute of the frame and iframe elements',
															SCR28:
													...
													return (
														...
														(n.failures = {
															...
															F20:
																'Not updating text alternatives when changes to non-text content occur',
															F68:
																'Association of label and user interface controls not being programmatically determined',
															F79:
														...
														if (
															(t.isArray(
																...
																(o = t.map(
																	i.testAggregators,
																	(t) => {
																		return new e.lib.wcag2.TestAggregator(
																			t,
																			s,
																			r
																		);
															...
															o.push(
																new e.lib.wcag2.TestAggregator(
																	d,
																	a,
																	r
																)
												...
												(e.lib.wcag2.TestAggregator = (function () {
													...
													function a(n, i) {
														...
														return (
															t.each(
																n,
																(t, n) => {
																	var a = new e.lib.wcag2.EarlAssertion(
																		i
																	);
																	n &&
																		(a.outcome.pointer = u.getPointer(
																			n
																		)),
																		s.push(
																			a
													...
													return (
														(c.prototype.filterDataToTests = function (
															e
														) {
															var n = t.map(
																	this.tests,
														...
														(c.prototype.getResults = function (
															...
															return (
																...
																n
																	? (0 ===
																			n.length &&
																			((i = new e.lib.wcag2.EarlAssertion(
																				{
																					testCase: this
																						.id,
																					subject: this
								...
								(e.prototype.process = function (t, e, n) {
									...
									return a.prototype.process.call(
										this,
										t,
										e,
										(a) => {
											var o = {
												...
												testCollectionComplete(i, s) {
													var o = r.getIssuesFromCollection(
														s,
														t.editor,
														a
													);
											...
											CKEDITOR.tools.extend(s, o, !0),
												s.jsonPath ||
													(s.jsonPath = r.jsonPath),
												i(e.$).quail(s);
										}
									);
								}),
								(e.prototype.getIssuesFromCollection = function (
									t,
									e,
									n
								) {
										...
										t.each((t, n) => {
											...
											'failed' === n.get('status') &&
												(s.issueDetails[a] ||
													(s.issueDetails[
														a
													] = s.getIssueDetailsFromTest(
														n,
														e
													)),
												s.addIssuesFromTest(n, i));
										}),
										i
									);
								}),
								(e.prototype.getIssueDetailsFromTest = function (
									t,
									e
								) {
									function n(t, e) {
										var n = CKEDITOR.tools.objectKeys(t),
											i = y.getPreferredLanguage(
												e.language,
												e.defaultLanguage,
												n
											);
									...
									var i = [],
										...
										a =
											s &&
											CKEDITOR.tools.objectKeys(s)[0];
									a &&
										(i.push('WCAG2.0'),
										i.push(a),
										i.push(s[a].techniques.join(',')));
									var r = t.get('title') || {},
										o = t.get('description') || {};
								...
								(e.prototype.addIssuesFromTest = function (
									t,
									e
								) {
									var n = this,
									...
									t.each((t, a) => {
										if (n.isValidTestCase(a)) {
											...
											'failed' == c.status &&
												((r = new o(
													{
														originalElement: new CKEDITOR.dom.element(
															c.element
														),
														testability: s,
														id: i,
								...
								(e.prototype._filterIssue = function (t, e) {
									...
									return i instanceof CKEDITOR.dom.element ==
										!1
										? !1
										: ((n = i.$), n && n.tagName ? !0 : !1);
								}),
				...
				getStylesSkinName() {
					...
					return 'moono' == CKEDITOR.skinName && (t = 'moono'), t;
				},
			}),
				(CKEDITOR.plugins.a11ychecker = {
					rev: '74912469eb64a44872768eace7468041d843dee6',
				});
		})(),
		(w = void 0);
})();
